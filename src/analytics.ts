 ...
 * metric can be segmented by site, device, traffic source, or motion preference.
...
export const trackEvent = (
  ...
  if (options?.sendBeacon) {
    // For events fired right before a navigation (e.g. an outbound App Store
    // link) — a beacon still delivers as the page unloads.
